...
D3D11Swapchain::D3D11Swapchain(const SwapchainDescription& description)
{
    ...
    BT_D3D11_CHECK(D3D11Renderer::GetDXGIFactory()->CreateSwapChain(
        D3D11Renderer::GetDevice(), &swapchain_desc, &m_swapchain));
